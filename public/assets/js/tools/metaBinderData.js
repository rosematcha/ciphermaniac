...
/**
 * @typedef {object} DeckRecord
 * @property {string} id
 * @property {string} player
 * @property {number|null} placement
 * @property {string} archetype
 * @property {DeckCard[]} cards
 */

/**
 * @typedef {object} ArchetypeStatsEntry
 * @property {string} canonical
 * @property {string} displayName
 * @property {number} deckCount
 * @property {Set<string>} originalNames
 */

/**
 * @typedef {object} BinderCard
 * @property {string} id
 * @property {string} name
 * @property {string|null} set
 * @property {string|number|null} number
 * @property {string|null} priceKey
 * @property {string|null} category
 * @property {string|null} trainerType
 * @property {string|null} energyType
 * @property {number} maxCopies
 * @property {number} totalDecksWithCard
 * @property {number} deckShare
 * @property {Array<object>} usageByArchetype
 * @property {Array<object>} usageByTournament
 * @property {number} highUsageArchetypes
 * @property {number} moderateUsageArchetypes
 */

/**
 * @typedef {object} BinderArchetypeStat
 * @property {string} canonical
 * @property {string} displayName
 * @property {number} deckCount
 * @property {string[]} originalNames
 */

/**
 * @typedef {object} BinderMeta
 * @property {number} totalDecks
 * @property {number} allDecks
 * @property {string[]} tournaments
 * @property {BinderArchetypeStat[]} archetypeStats
 */

/**
 * @typedef {object} ArchetypeGroup
 * @property {string} canonical
 * @property {string} displayName
 * @property {BinderCard[]} cards
 */

/**
 * @typedef {object} BinderSections
 * @property {BinderCard[]} aceSpecs
 * @property {BinderCard[]} staplePokemon
 * @property {ArchetypeGroup[]} archetypePokemon
 * @property {BinderCard[]} frequentSupporters
 * @property {BinderCard[]} nicheSupporters
 * @property {BinderCard[]} stadiums
 * @property {BinderCard[]} tools
 * @property {BinderCard[]} frequentItems
 * @property {BinderCard[]} nicheItems
 * @property {BinderCard[]} specialEnergy
 * @property {BinderCard[]} basicEnergy
 */

/**
 * @typedef {object} AnalyzedEvents
 * @property {Array<any>} events
 * @property {Map<string, ArchetypeStatsEntry>} archetypeStats
 */

/**
 * @typedef {{ meta: BinderMeta, sections: BinderSections }} BinderDataset
 */
