...
class ArchetypeCacheManager {
    ...
    async getFilteredData(tournament, archetypeBase, includeId, excludeId, includeOperator = null, includeCount = null) {
        ...
        try {
            ...
            const report = generateFilteredReport(decks, archetypeBase, includeId, excludeId, includeOperator, // Cast to Operator type
            includeCount);
            ...
            throw new AppError(ErrorTypes.PARSE, `Filter combination not found and client-side generation failed: inc:${includeId || ''}|exc:${excludeId || ''}`, clientError.message, // Pass message as userMessage
            {
