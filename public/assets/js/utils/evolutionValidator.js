 ...
 */
export function getBasePokemonName(cardName) {
    // Remove ex suffix
 ...
 */
export function getTrainerName(cardName) {
 ...
 */
export function isExPokemon(cardName) {
 ...
 */
export function isBabyPokemon(cardName) {
 ...
 */
export function getPreEvolutions(pokemonName) {
 ...
 */
export function areNamedVariantsCompatible(evolution, basic) {
