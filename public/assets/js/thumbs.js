 ...
 * @param {string} setCode - Set acronym (e.g., "OBF")
 * @param {string|number} number - Card number (will be padded with leading zeroes)
 * @param {boolean} useSm - true for SM (small), false for XS (extra-small)
