 ...
 * @param height
 */
export function createChartSkeleton(height: string = '300px'): HTMLElement {
    const skeleton = document.createElement('div');
 ...
 */
export function createHistogramSkeleton(): HTMLElement {
    const skeleton = document.createElement('div');
 ...
 */
export function createEventsTableSkeleton(): HTMLElement {
    const skeleton = document.createElement('div');
...
// Extend HTMLElement to include _originalContent
 ...
 */
export function showSkeleton(target: ExtendedHTMLElement | null, skeletonElement: HTMLElement | DocumentFragment): void {
 ...
 * @param newContent
 */
export function hideSkeleton(target: ExtendedHTMLElement | null, newContent: string | Node | null = null): void {
    if (!target) {
        return;
    }
 ...
 */
export function showGridSkeleton(): void {
 ...
 * @param newContent
 */
export function hideGridSkeleton(newContent: string | Node | null = null): void {
    const grid = document.getElementById('grid') as ExtendedHTMLElement | null;
    if (!grid) {
        return;
    }
